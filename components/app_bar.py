        ...
        children=[
            ...
            html.Div([
                ...
                html.Div([
                    html.A("Home", href="/", 
                           style={
                               "fontSize": "20px", "fontWeight": "bold", "color": "white", "marginRight": "70px",
                    ...
                    html.A("Clinical Utility Profiling - Decision Analytic Dashboard", href="/",
                         style={
                             ...
                             "textAlign": "center", "padding": "5px", "marginRight": "120px", "textDecoration": "none"
                         }),
                    html.A("Read Me", href="/readme", target="_blank", 
                           style={
                               "fontSize": "20px", "fontWeight": "bold", "color": "white", "marginRight": "100px",
                               "textDecoration": "none", "padding": "5px", "transition": "color 0.3s ease, background-color 0.3s ease"
                           }, className="tab-link"),
