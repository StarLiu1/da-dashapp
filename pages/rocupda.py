...
def get_layout():
    return  html.Div([
                ...
                html.Div([
                    html.Div([
                        html.Div([
                            html.Div([
                                ...
                                ], style={'paddingLeft': '10px', 'width': '100%', 'overflowY': 'auto', 'maxHeight': '350px'}),
                    ...
                    ], style={'height': '100%', 'width': '20%', 'flexDirection': 'row', "paddingLeft": "10px"}),
                    html.Div([
                        html.Div([
                            html.Div([
                                html.Div(
                    ...
                    ], style={'height': '100vh', 'display': 'flex', 'width': '80%', 'flexDirection': 'column'}),
...
def update_plots(slider_cutoff, click_data, uTP, uFP, uTN, uFN, pD, data_type, upload_contents, disease_mean, disease_std, healthy_mean, healthy_std, n_clicks, submitName_click, label_names, figure, roc_store, button_text, current_mode, shape_store):
    ...
    optimal_cutoff_text = f"H/B of {HoverB:.2f} gives a slope of {slope_of_interest:.2f} at the optimal cutoff {cutoff_optimal_pt:.2f}"
